 ...
 * 当天过期的服务包定时脚本
 * 该脚本每天早上7点整运行
 * 发现当天过期服务包，并根据服务包找到用户相关会话，发送指定消息通知用户
 * 0 7  * * * curl : http://localhost:9050/1/service_package/crontab/current_overdue
 */
...
module.exports = {
  async getAction() {
    const result = await sp_order_service.getExpireGroups();
    const message = '尊敬的会员，本服务已经到期，服务群将于7日后解散，感谢您一直以来的关注和支持。';
