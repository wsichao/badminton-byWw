...
module.exports = {
  ...
  getAction: function () {
    ...
    let trades = [];
    return _trade_service.getVipMembershipTrades(req.userId, 'zlycare', options)
    ...
    .then(function(_products){
      ...
      trades = trades.map(function(_trade){
        ...
        trade.certification_use = '商家扫码后，可为你报销' + _trade.value + '元';
