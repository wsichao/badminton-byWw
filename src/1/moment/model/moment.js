...
module.exports = {
  config: {
    ...
    originalUser: {
      ...
      docChatNum: String,
      userCity:String,
      moment: {type: Backend.Schema.Types.ObjectId, ref: 'Moment'}, //该动态为转发时,被转发的动态id
    },
    //
    ...
    hongbao: {type: Backend.Schema.Types.ObjectId, ref: 'Hongbao'}, //绑定的红包
    hongbaoTotalCount: Number, //红包总数
    hongbaoTotalValue: Number, //红包总金额

    //被推荐人

    recommendedUser: {type: Backend.Schema.Types.ObjectId, ref: 'User'},
