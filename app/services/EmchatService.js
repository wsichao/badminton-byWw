...
var token;
var client_id = Constants.ZLYCARE_DOC_EMCHAT_ID_RUNTIME;
var client_secret = Constants.ZLYCARE_DOC_EMCHAT_SECRET_RUNTIME;
...
var _http_request = function (json) {
  ...
  var path = '/' + Constants.ZLYCARE_DOC_EMCHAT_ORG_NAME + '/' + Constants.ZLYCARE_DOC_EMCHAT_APP_NAME + json.path;
