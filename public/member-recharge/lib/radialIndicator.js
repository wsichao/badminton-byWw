...
;(function ($, window, document) {
    ...
    Indicator.prototype = {
        ...
        value: function (val) {
            ...
            var perVal = Math.round(((val - minVal) * 100 / (maxVal - minVal)) * 100) / 100, //需要展示的百分比数
            ...
            console.log(quart);
            /*ctx.arc(center, center, indOption.radius,(3*quart),((circ) * perVal / 100) - quart, false);*/
            ctx.stroke();
            console.log(-(quart),((circ) * perVal / 100) - quart);
